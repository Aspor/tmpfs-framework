...
**networkPlotter.py** reads the same data from tmpfs path, prints current values and start drawing a plot of total transmitted bytes using matplotlib. Shows three different ways to access the data on tmpfs:
